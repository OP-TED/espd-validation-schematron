...
set four_filename_sch="sch\04 ESPD Resp EO BR.sch"
...
set seven_filename_sch="sch\05 ESPD Resp Lead BR.sch"
set seven_filename_xsl="output\xsl\05 ESPD Resp Lead BR.xsl"
set eight_filename_sch="sch\04 ESPD Resp Criterion BR.sch"
