...
rem | espd-schematron, v4.1.0 2024/07  |
rem +----------------------------------+
...
mkdir logs\dist\ESPD-EDM\validation\ESPDRequest\sch logs\dist\ESPD-EDM\validation\ESPDRequest\xsl logs\dist\ESPD-EDM\validation\ESPDResponse\sch logs\dist\ESPD-EDM\validation\ESPDResponse\xsl logs\dist\ESPD-EDM\validation\common\cva logs\dist\ESPD-EDM\validation\common\sch logs\dist\validator-resources-espd\resources\v4.1.0\ESPDRequest logs\dist\validator-resources-espd\resources\v4.1.0\ESPDResponse logs\dist\validator-resources-espd\resources\v4.1.0\gc logs\dist\validator-resources-espd\resources\v4.1.0\xsdrt  >> %log_dist%
...
copy /Y /V ESPDRequest\xsl\*.* logs\dist\validator-resources-espd\resources\v4.1.0\ESPDRequest >> %log_dist%
copy /Y /V ESPDResponse\xsl\*.* logs\dist\validator-resources-espd\resources\v4.1.0\ESPDResponse >> %log_dist%
copy /Y /V gc\*.* logs\dist\validator-resources-espd\resources\v4.1.0\gc >> %log_dist%
xcopy /S /Y common\xsdrt logs\dist\validator-resources-espd\resources\v4.1.0\xsdrt >> %log_dist%
