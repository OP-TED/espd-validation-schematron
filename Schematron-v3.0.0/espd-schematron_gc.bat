...
rem
rem  $Id: espd-schematron,v 3.0.0 2021/02 $
rem
...
call common\bat\w3cschema common\xsd\genericode.xsd "gc\docref-content-type.gc" 2>&1 >logs\1-GC_Files.txt
call common\bat\w3cschema common\xsd\genericode.xsd "gc\EOIDType.gc" 2>&1 >logs\1-GC_Files.txt
call common\bat\w3cschema common\xsd\genericode.xsd "gc\economic-operator-size.gc" 2>&1 >logs\1-GC_Files.txt
