...
set xml_test="..\xml\espd-request.xml"
set xsd_test="..\xsdrt\maindoc\ESPDRequest-1.0.xsd"
set cva_filename="..\..\common\cva\ESPD-codelist-values.cva"
set xslt_cva2sch="..\..\common\xsl\Crane-cva2schXSLT.xsl"
set sch_xsl_filename="output\ESPD-codelist-values.sch.xsl"
set sch_filename="output\sch\ESPD-codelist-values.sch"
