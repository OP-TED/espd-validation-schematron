...
call bat\w3cschema xsd\genericode.xsd "..\..\common\gc\ActivityType-CodeList.gc" 2>&1 >output\logs\1-GC_Files.txt
call bat\w3cschema xsd\genericode.xsd "..\..\common\gc\AmountType-CodeList.gc" 2>&1 >output\logs\1-GC_Files.txt
...
call bat\w3cschema xsd\genericode.xsd "..\..\common\gc\ContractType-CodeList.gc" 2>&1 >output\logs\1-GC_Files.txt
