...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:office="urn:oasis:names:tc:opendocument:xmlns:office:1.0" xmlns:style="urn:oasis:names:tc:opendocument:xmlns:style:1.0" xmlns:table="urn:oasis:names:tc:opendocument:xmlns:table:1.0" xmlns:text="urn:oasis:names:tc:opendocument:xmlns:text:1.0" xmlns:espd="urn:com:grow:espd:02.00.00" xmlns:cac="urn:X-test:UBL:Pre-award:CommonAggregate" xmlns:cbc="urn:X-test:UBL:Pre-award:CommonBasic" xmlns:util="java:java.util.UUID">
	...
	<cbc:IssueDate><xsl:value-of select="//./*[./name()='cbc:IssueDate']"/></cbc:IssueDate>


	<cbc:IssueTime><xsl:value-of select="//./*[./name()='cbc:IssueTime']"/></cbc:IssueTime>
	...
	<cbc:VersionID schemeAgencyID="EU-COM-GROW" schemeVersionID="2.0"><xsl:value-of select="//./*[./name()='cbc:VersionID']"/></cbc:VersionID>
	...
	<cbc:ProcedureCode listID="ProcedureType"  listAgencyName="EU-COM-GROW" listVersionID="02.00.00"><xsl:value-of select="//./*[./name()='cbc:ProcedureCode']"/></cbc:ProcedureCode>
	...
	<cbc:QualificationApplicationTypeCode listID="QualificationApplicationType"  listAgencyName="EU-COM-GROW" listVersionID="02.00.00"><xsl:value-of select="//./*[./name()='cbc:QualificationApplicationTypeCode']"/></cbc:QualificationApplicationTypeCode>
