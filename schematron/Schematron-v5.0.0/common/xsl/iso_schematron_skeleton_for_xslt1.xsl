...
<xsl:template match="*" mode="stylesheetbody">
   ...
   for ZIP archives.
	...
	<xsl:apply-templates mode="do-keys"   select="/iso:schema/iso:pattern/xsl:key"/>
    <xsl:text>&#10;&#10;</xsl:text><xsl:comment>VARIABLES</xsl:comment><xsl:text>&#10;</xsl:text>
	<xsl:apply-templates mode="do-vars"   select="/iso:schema/iso:pattern/xsl:variable"/>
...
<!-- ============================================================== -->
	...
	<xsl:template match="xsl:variable" mode="do-vars">
