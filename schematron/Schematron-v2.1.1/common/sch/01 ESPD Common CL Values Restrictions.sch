...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <pattern id="BR-COM-CL-RESTR">
        ...
        <rule context="cbc:ValueDataTypeCode">
            <let name="gc" value="document('../gc/ResponseDataType.gc')//SimpleCodeList"/>
        ...
        <rule context="cbc:WeightingTypeCode">
            <let name="gc" value="document('../gc/WeightingType.gc')//SimpleCodeList"/>
            <let name="currentValue" value="."/>
        ...
        <rule context="cac:TenderingCriterion/cbc:EvaluationMethodTypeCode">
            <let name="gc" value="document('../gc/EvaluationMethodType.gc')//SimpleCodeList"/>
            <let name="currentValue" value="."/>
        ...
        <rule context="cbc:CriterionTypeCode">
            <let name="gc" value="document('../gc/ESPD-CriteriaTaxonomy_V2.1.1.gc')//SimpleCodeList"/>
            <let name="currentValue" value="."/>
        ...
        <rule context="cbc:BooleanGUIControlType">
            <let name="gc" value="document('../gc/BooleanGUIControlType.gc')//SimpleCodeList"/>
            <let name="currentValue" value="."/>
        ...
        <rule context="cbc:CPVCodes">
            <let name="gc" value="document('../gc/CPVCodes.gc')//SimpleCodeList"/>
            <let name="currentValue" value="."/>
        ...
        <rule context="cac:EconomicOperatorParty/cac:EconomicOperatorRole/cbc:RoleCode">
            <let name="gc" value="document('../gc/EORoleType.gc')//SimpleCodeList"/>
            <let name="currentValue" value="."/>
        ...
        <rule context="cbc:QualificationApplicationTypeCode">
            <let name="gc" value="document('../gc/QualificationApplicationType.gc')//SimpleCodeList"/>
            <let name="currentValue" value="."/>
