...
set xml_test="..\..\common\xml\ESPDResponse-CriteriaTaxonomy-REGULATED.V2.0.3.xml"
...
set ten_output="output\05 ESPD Resp Self-contained BR.xml"
...
echo.
echo   bat\xslt %xml_test% %eleven_filename_xsl% :: output\logs\14-XML_Validation.txt
call bat\xslt %xml_test% %eleven_filename_xsl% %eleven_output% >output\logs\14-XML_Validation.txt
echo Result: %errorlevel%
if %errorlevel% neq 0 goto :error
...
echo.
echo   bat\xslt %xml_test% %twelve_filename_xsl% :: output\logs\15-XML_Validation.txt
call bat\xslt %xml_test% %twelve_filename_xsl% %twelve_output% >output\logs\15-XML_Validation.txt
echo Result: %errorlevel%
if %errorlevel% neq 0 goto :error
