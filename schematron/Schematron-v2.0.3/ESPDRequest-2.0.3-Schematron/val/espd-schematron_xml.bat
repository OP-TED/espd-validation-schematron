...
set xml_test="..\..\common\xml\ESPD-CriteriaTaxonomy-SELFCONTAINED.V2.0.3_(2).xml"
rem set xml_test="C:\Users\mfontsan\Documents\Mis archivos recibidos\XSLOutput2.1Request.xml"
...
set nine_output="output\05 ESPD Req Self-contained BR.xml"
