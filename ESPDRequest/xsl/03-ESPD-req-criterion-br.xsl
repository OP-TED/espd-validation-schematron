...
<xsl:stylesheet xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2"
   ...
   <xsl:template match="espd:QualificationApplicationRequest"
		...
		<!--ASSERT -->
      <xsl:choose>
         <xsl:when test="cac:TenderingCriterion[cbc:CriterionTypeCode='exg-crim-part']     and cac:TenderingCriterion[cbc:CriterionTypeCode='exg-crim-corrpt']    and cac:TenderingCriterion[cbc:CriterionTypeCode='exg-crim-fraud']    and cac:TenderingCriterion[cbc:CriterionTypeCode='exg-crim-terror']    and cac:TenderingCriterion[cbc:CriterionTypeCode='exg-crim-laund']    and cac:TenderingCriterion[cbc:CriterionTypeCode='exg-crim-traffick']    and cac:TenderingCriterion[cbc:CriterionTypeCode='exg-pmt-bre-tax']    and cac:TenderingCriterion[cbc:CriterionTypeCode='exg-pmt-bre-ssc']"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="cac:TenderingCriterion[cbc:CriterionTypeCode='exg-crim-part'] and cac:TenderingCriterion[cbc:CriterionTypeCode='exg-crim-corrpt'] and cac:TenderingCriterion[cbc:CriterionTypeCode='exg-crim-fraud'] and cac:TenderingCriterion[cbc:CriterionTypeCode='exg-crim-terror'] and cac:TenderingCriterion[cbc:CriterionTypeCode='exg-crim-laund'] and cac:TenderingCriterion[cbc:CriterionTypeCode='exg-crim-traffick'] and cac:TenderingCriterion[cbc:CriterionTypeCode='exg-pmt-bre-tax'] and cac:TenderingCriterion[cbc:CriterionTypeCode='exg-pmt-bre-ssc']">
