...
set xml_test="..\common\xml\EXTENDED-ESPDRequest-2.1.1.xml"
...
set nine_filename_xsl="xsl\05 ESPD Req Extended BR.xsl"
...
call ..\common\bat\w3cschema %xsd_test% %xml_test% >%xsd_output%
echo.
